...
INSERT INTO credit_card (id, account_id, card_type, card_number, first_name, last_name, expiration_date,
                         security_code_hash)
VALUES (1, 2, 'VISA', '4024007183796514', 'Nikola', 'Karnstein', '12/25',
        'BDBm2vIQlSOnSQ1L+tR2baVxmVCitfltGS/AU36E8yo='), # 152
