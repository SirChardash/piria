...
export default function TourLoader({endpoint, noResultText, showStatus, context, canBook, canVisit}) {
    ...
    return <TourList list={data.tours} showStatus={showStatus} canBook={canBook} context={context} canVisit={canVisit}/>
}